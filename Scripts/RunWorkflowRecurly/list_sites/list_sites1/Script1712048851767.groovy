...
create_site_request.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(create_site_payload)))
...
WSBuiltInKeywords.verifyResponseStatusCode(create_site_response, 201)

// Step 4: Verify that the response status code is 201
WSBuiltInKeywords.verifyResponseStatusCode(create_site_response, 201)
