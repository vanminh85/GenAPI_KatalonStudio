...
acquisition_update_request.setRestUrl(base_url + "/accounts/{account_id}/acquisition")
...
acquisition_request.setRestUrl(base_url + "/accounts/{account_id}/acquisition")
acquisition_request.setRestRequestMethod("PUT")
acquisition_request.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(acquisition_payload))))
...
post_request.setRestUrl(base_url + "/accounts/{account_id}/acquisition")
...
assertThat(post_response.getStatusCode()).isEqualTo(422)
