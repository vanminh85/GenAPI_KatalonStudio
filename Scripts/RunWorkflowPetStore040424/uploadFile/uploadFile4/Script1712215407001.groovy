...
// Step 4
def invalidImageData = "invalid_image_data"
def requestStep4 = new RequestObject()
requestStep4.setRestUrl("https://petstore.swagger.io/v2/pet/" + createdPetId + "/uploadImage")
...
WSBuiltInKeywords.verifyResponseStatusCode(responseStep4, 400)
