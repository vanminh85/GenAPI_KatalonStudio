...
create_with_list_request.setRestUrl("${GlobalVariable.base_url}/user/createWithList")
...
WSBuiltInKeywords.verifyResponseStatusCode(create_with_list_response, 400)
