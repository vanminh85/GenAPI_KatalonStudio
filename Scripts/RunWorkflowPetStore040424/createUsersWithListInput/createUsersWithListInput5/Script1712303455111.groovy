...
request1.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["id": 5, "name": "Test Category"]))))
...
request2.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["id": 5, "category": ["id": 5, "name": "Test Category"], "name": "Test Pet", "photoUrls": ["url1", "url2"], "status": "available"]))))
...
request3.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["id": 5, "petId": 5, "quantity": 1, "shipDate": "2022-01-01T00:00:00Z", "status": "placed", "complete": false]))))
...
request4.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson([["id": 5, "username": "testuser5", "firstName": "Test", "lastName": "User", "email": "testuser5@example.com", "password": "password123", "phone": "1234567890", "userStatus": 1]])))
