...
petPayload = '{"name": "doggie__unique__", "photoUrls": ["photoUrl1__unique__", "photoUrl2__unique__"]}'
...
request2.setRestUrl("https://petstore.swagger.io/v2/pet/findByStatus?status=available")
