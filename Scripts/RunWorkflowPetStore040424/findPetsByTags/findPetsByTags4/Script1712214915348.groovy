...
def petPayload = '{"name": "Buddy__unique__", "photoUrls": ["https://example.com/photo1", "https://example.com/photo2"], "tags": [{"id": 1, "name": "tag1__unique__"}]}'
...
request2.setRestUrl("https://petstore.swagger.io/v2/pet/findByTags?tags=tag1,tag2")
