...
def order_payload = [
	"petId": pet_response.getResponseText("id"),
	"quantity": 1
]
...
WSBuiltInKeywords.verifyResponseStatusCode(createWithArray_response, 200)

// Step 7: Verify that the response status code is 200
WSBuiltInKeywords.verifyResponseStatusCode(createWithArray_response, 200)
