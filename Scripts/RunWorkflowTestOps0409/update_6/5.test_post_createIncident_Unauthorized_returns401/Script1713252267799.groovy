...
def teamPayload = '{"id": 1, "name": "Team__unique__", "role": "OWNER", "users": [], "organizationId": 1}'
...
def projectPayload = '{"id": 1, "name": "Project__unique__", "teamId": ' + teamId + '}'
...
def incidentPayload = '{"id": 1, "name": "Incident__unique__", "description": "Incident Description", "projectId": ' + projectId + ', "teamId": ' + teamId + ', "urlIds": [], "executionTestResultIds": [], "order": 1}'
...
WSBuiltInKeywords.verifyResponseStatusCode(incidentResponse, 401)
