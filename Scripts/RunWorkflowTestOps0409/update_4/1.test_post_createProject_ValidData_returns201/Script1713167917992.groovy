...
team_payload = '{"name": "Test Team", "role": "OWNER", "users": [], "organizationId": 123}'
...
project_payload = '{"name": "Test Project", "teamId": ' + team_id + ', "timezone": "UTC", "status": "ACTIVE", "canAutoIntegrate": true, "sampleProject": false}'
