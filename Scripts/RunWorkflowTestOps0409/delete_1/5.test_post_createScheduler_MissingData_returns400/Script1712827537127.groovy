...
request1.setRestUrl("https://testops.katalon.io/api/v1/organizations/1/trial-request?feature=KSE")
...
// Step 4
def runConfigPayload = '{"id": 1, "name": "RunConfig__unique__", "command": "echo \'Hello, World!\'", "projectId": 1, "teamId": 1, "testProjectId": 1, "releaseId": 1, "testSuiteCollectionId": 1, "testSuiteId": 1, "executionProfileId": 1, "baselineCollectionGroupOrder": 1, "timeOut": 60, "configType": "TSC"}'
...
// Step 5
def schedulerPayload = '{"id": 1, "name": "Scheduler__unique__", "startTime": "2022-01-01T00:00:00Z", "nextTime": "2022-01-01T00:00:00Z", "endTime": "2022-01-01T00:00:00Z", "active": true, "interval": 5, "intervalUnit": "MINUTE", "runConfigurationId": 1, "exceededLimitTime": false}'
def request5 = new RequestObject()
request5.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(schedulerPayload)))
request5.setRestUrl("https://testops.katalon.io/api/v1/test-projects/1/schedulers")
