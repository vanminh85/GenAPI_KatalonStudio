...
createSchedulerRequest.setBodyContent(new HttpTextBodyContent(createSchedulerPayload))
...
updateSchedulerRequest.setBodyContent(new HttpTextBodyContent(updateSchedulerPayload))
