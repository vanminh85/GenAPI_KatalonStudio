...
createSchedulerRequest.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(schedulerPayload)))
...
updateSchedulerRequest.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(updatedSchedulerPayload)))
