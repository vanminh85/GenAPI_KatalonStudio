...
def userPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"firstName": "John__unique__", "lastName": "Doe__unique__"}'))
...
WSBuiltInKeywords.verifyResponseStatusCode(userOrgFeatureResponse, 200)
