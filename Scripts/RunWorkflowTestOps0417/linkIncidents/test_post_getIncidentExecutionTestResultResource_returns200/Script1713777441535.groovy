...
// Step 5: Send a GET request to retrieve an Execution Test Result to a Task
def getExecutionTestResultRequest = new RequestObject()
getExecutionTestResultRequest.setRestUrl("https://testops.katalon.io/api/v1/test-results/1/incidents")
getExecutionTestResultRequest.setRestRequestMethod("GET")
addAuthHeader(getExecutionTestResultRequest)
def getExecutionTestResultResponse = WSBuiltInKeywords.sendRequest(getExecutionTestResultRequest)
WSBuiltInKeywords.verifyResponseStatusCode(getExecutionTestResultResponse, 200)
