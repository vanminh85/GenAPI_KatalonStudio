...
// Step 4: Publish the created Test Project
...
// Step 5: Publish the same Test Project again
def publishAgainRequest = new RequestObject()
publishAgainRequest.setRestUrl("https://testops.katalon.io/api/v1/test-management/test-projects/${testProjectId}/publish")
publishAgainRequest.setRestRequestMethod("POST")
addAuthHeader(publishAgainRequest)
addContentTypeHeader(publishAgainRequest)
def publishAgainResponse = WSBuiltInKeywords.sendRequest(publishAgainRequest)
WSBuiltInKeywords.verifyResponseStatusCode(publishAgainResponse, 200)
