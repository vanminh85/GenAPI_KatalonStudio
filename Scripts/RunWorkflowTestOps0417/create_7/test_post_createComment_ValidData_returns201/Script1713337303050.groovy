...
def teamPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(['name': 'Test Team', 'role': 'OWNER'])))
...
def projectPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(['name': 'Test Project', 'teamId': teamId])))
...
def commentPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(['objectId': 123, 'projectId': projectId, 'content': 'Test comment', 'teamId': teamId, 'objectType': 'TEST_CASE', 'bySystem': false])))
