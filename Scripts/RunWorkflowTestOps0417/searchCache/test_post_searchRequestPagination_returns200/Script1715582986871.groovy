...
def searchRequestPaginationPayload = [
	"page": 1,
	"size": 10
]

def request = new RequestObject()
request.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["searchRequestPagination": searchRequestPaginationPayload]))))
