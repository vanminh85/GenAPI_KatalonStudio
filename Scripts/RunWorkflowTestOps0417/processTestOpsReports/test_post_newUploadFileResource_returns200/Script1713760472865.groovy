...
def uploadFileResourceData = [
	path: "/uploads/test_file",
	fileName: "test_file",
	type: "TESTOPS_REPORT_METADATA",
...
def bodyContent = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(uploadFileResourceData)))
