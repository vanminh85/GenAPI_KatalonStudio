...
runConfigPayload = '{"name": "RunConfig__unique__", "command": "echo \'Hello, World!\'", "projectId": 1, "teamId": 1, "testProjectId": 1}'
...
// Step 3: Create a new Scheduler with a missing required field
...
schedulerPayload = '{"name": "Scheduler__unique__", "startTime": "2022-01-01T00:00:00Z", "interval": 5, "intervalUnit": "MINUTE", "runConfigurationId": 1}'
