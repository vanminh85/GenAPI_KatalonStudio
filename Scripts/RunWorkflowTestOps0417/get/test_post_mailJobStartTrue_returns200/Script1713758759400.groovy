...
def userSettingPayload = '{"mailJobStart": true, "mailJobEnd": false, "mailExecution": false, "mailExecutionStatus": "DISABLED", "mailWeeklyUpdate": false}'
userSettingRequest.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(userSettingPayload)))
