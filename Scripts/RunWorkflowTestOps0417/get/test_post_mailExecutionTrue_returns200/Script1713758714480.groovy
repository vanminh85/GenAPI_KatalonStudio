...
// Step 1: Create a new User Setting with 'mailExecution' set to true
user_setting_payload = '{"mailJobStart": false, "mailJobEnd": false, "mailExecution": true, "mailExecutionStatus": "ENABLED", "mailWeeklyUpdate": false}'
...
if (WSBuiltInKeywords.verifyResponseStatusCode(response, 200)) {
    ...
    println("Test Failed: Status code is " + response.getStatusCode())
}
