...
def userPayload = '{"email": "test@example.com", "firstName": "John", "lastName": "Doe", "password": "password123", "invitingUrl": "https://example.com", "systemRole": "USER", "businessUser": true}'
...
def invalidUploadedPath = "invalid_path.jpg"
def avatarPayload = '{"uploadedPath": invalidUploadedPath}'
