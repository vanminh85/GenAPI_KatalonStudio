...
def user_payload = '{"email": "test@example.com", "firstName": "John", "lastName": "Doe", "password": "password123", "invitingUrl": "https://example.com", "systemRole": "USER", "businessUser": true}'
...
def avatar_payload = '{"uploadedPath": "/path/to/avatar/image.jpg"}'
avatarRequest.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(avatar_payload)))
