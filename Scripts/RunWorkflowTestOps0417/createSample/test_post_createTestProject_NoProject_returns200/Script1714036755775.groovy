...
project_payload = '{"name": "ProjectName__unique__", "teamId": ' + team_response.getResponseText() + ',"timezone": "UTC","status": "ACTIVE"}'
...
git_repo_payload = '{"testProjectId": ' + project_response.getResponseText() + ',"name": "GitRepoName__unique__","repository": "https://github.com/example.git","branch": "main","username": "username","password": "password","accessKeyId": "accessKeyId","secretAccessKey": "secretAccessKey","projectId": 1,"teamId": 1}'
...
test_project_payload = '{"name": "TestProjectName__unique__","description": "Test project description","defaultTestProject": true,"uploadFileId": 1,"projectId": ' + project_response.getResponseText() + ',"teamId": ' + team_response.getResponseText() + ',"type": "GIT","gitRepository": {"id": ' + git_repo_response.getResponseText() + ',"name": "GitRepoName__unique__"}}'
