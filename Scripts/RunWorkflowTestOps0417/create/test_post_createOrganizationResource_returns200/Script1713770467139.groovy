...
organizationPayload = '{"name": "Organization__unique__", "role": "OWNER", "domain": "example.com", "subdomainUrl": "example", "tier": "PROFESSIONAL", "requestedUserVerified": true}'

request = new RequestObject()
request.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(organizationPayload)))
request.setRestUrl("https://testops.katalon.io/api/v1/organizations/${id}/trial-request")
