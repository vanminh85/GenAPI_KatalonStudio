...
def orgPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["name": "Organization__unique__", "role": "OWNER"])))
...
def teamPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["name": "Team__unique__", "role": "OWNER", "organizationId": orgResponse.getResponseText("id"))]))
...
def projectPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(["name": "Project__unique__", "teamId": teamResponse.getResponseText("id"))]))
...
def runConfigPayload = new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson([
	...
	"teamId": teamPayload.getResponseText("organizationId"),
	"testProjectId": projectResponse.getResponseText("id"),
	"releaseId": projectResponse.getResponseText("id"),
	"testSuiteCollectionId": projectResponse.getResponseText("id"),
	"testSuiteId": projectResponse.getResponseText("id"),
	"executionProfileId": projectResponse.getResponseText("id"),
	...
	"genericCommand": "ls -l",
	"ksVersion": "1.0",
	"ksLocation": "/usr/local/bin",
	"executionMode": "SEQUENTIAL",
	"enabledKobitonIntegration": true,
	"enabledTestCloudTunnel": true,
	"triggerMode": "TESTOPS_SCHEDULER",
	"browserType": "CHROME",
	"xrayImportReportType": "PUSH_ON_PASSING_RUNS",
	"externalTestPlanId": "extPlan123"
]))
