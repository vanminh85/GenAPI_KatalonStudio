...
def payload = '{"code": "test_account__unique__", "email": "test@example.com", "first_name": "John", "last_name": "Doe", "company": "Test Company", "parent_account_id": "parent_account__unique__", "bill_to": "self"}'
