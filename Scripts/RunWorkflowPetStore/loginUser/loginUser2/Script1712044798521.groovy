...
login_request.getRestParameters().add(new TestObjectProperty("username", ConditionType.EQUALS, login_payload.username))
login_request.getRestParameters().add(new TestObjectProperty("password", ConditionType.EQUALS, login_payload.password))
