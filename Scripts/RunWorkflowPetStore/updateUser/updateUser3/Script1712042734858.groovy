...
// Step 4: Send a POST request to /user/{username} with an invalid username path parameter
def user_payload = [
	"id": 1,
	"username": "user1",
	"userStatus": 1
...
user_request.setRestUrl("${base_url}/user/invalid_username")
...
WSBuiltInKeywords.verifyResponseStatusCode(user_response, 404)
