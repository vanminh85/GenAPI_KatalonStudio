...
def upload_image_endpoint = "https://petstore.swagger.io/v2/pet/${invalid_pet_id}/uploadImage"
...
WSBuiltInKeywords.verifyResponseStatusCode(upload_image_response, 404)
