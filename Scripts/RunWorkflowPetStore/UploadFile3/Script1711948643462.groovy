...
upload_image_request.setBodyContent(new HttpTextBodyContent(replaceSuffixWithUUID(JsonOutput.toJson(upload_image_payload))))
upload_image_request.setRestUrl("https://petstore.swagger.io/v2/pet/uploadImage")
...
WSBuiltInKeywords.verifyResponseStatusCode(upload_image_response, 405)
