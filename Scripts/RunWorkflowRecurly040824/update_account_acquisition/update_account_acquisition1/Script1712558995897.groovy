...
def accountPayload = '{"code": "test_account__unique__", "acquisition": {"cost": {"currency": "USD", "amount": 100.0}, "channel": "direct_traffic", "subchannel": "online", "campaign": "summer_sale"}, "external_accounts": []}'
...
def acquisitionPayload = '{"cost": {"currency": "USD", "amount": 50.0}, "channel": "email", "subchannel": "newsletter", "campaign": "fall_promo"}'
